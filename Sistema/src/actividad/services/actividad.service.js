...
let ActividadService = class ActividadService {
    constructor(actividadRepository, emailNotificacionService) {
    ...
    findOne(id) {
        return this.actividadRepository.findOne({ id }, { relations: ['ueb', 'tipoActividad'] });
    }
    create(body) {
...
ActividadService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(actividad_entity_1.ActividadEntity))
], ActividadService);
