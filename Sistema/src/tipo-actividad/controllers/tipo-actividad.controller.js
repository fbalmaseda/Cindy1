...
], TipoActividadController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('obtener/:id'),
    __param(0, (0, common_1.Param)('id'))
], TipoActividadController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)('crear'),
    __param(0, (0, common_1.Body)())
], TipoActividadController.prototype, "create", null);
__decorate([
    (0, common_1.Put)('editar/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)())
], TipoActividadController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)('eliminar/:id'),
    __param(0, (0, common_1.Param)('id'))
], TipoActividadController.prototype, "delete", null);
TipoActividadController = __decorate([
    (0, common_1.Controller)('tipo_actividad')
], TipoActividadController);
exports.TipoActividadController = TipoActividadController;
//# sourceMappingURL=tipo-actividad.controller.js.map